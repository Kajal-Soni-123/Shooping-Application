...
//displaying all the available products of a selected category
elseif(isset($_GET['cat_id'])){
  ...
  <div class="card-body">
    ...
    echo'<h2 class="text-center text-danger container my-2"> Product of this category is not available</h2>';
