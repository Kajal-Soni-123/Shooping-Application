...
<html lang="en">
  ...
  <body>
    ...
    if(isset($_GET['success'])&& $_GET['success']=="true"){
      ...
      <strong>you are loggedin in successfully</strong>
    ...
    if(isset($_GET['success'])&& $_GET['success']=="false"){
      echo'<div class="alert alert-info alert-dismissible fade show my-0" role="alert">
      <strong>you are not registered please register first</strong>
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>';
    ...
    ?>
    <div class="container text-center my-3"><h3>Admin Login Form</h3></div>
